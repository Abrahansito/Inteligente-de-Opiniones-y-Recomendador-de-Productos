...
namespace PC4PROGRAMACION.MLRecomendacion
{
    public partial class MLModelRecomendacion
    {
        public const string RetrainFilePath =  @"MLRecomendacion\trainingdata\ratings-data-modelbuilder-corregidoo.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"ProductId",inputColumnName:@"ProductId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"Label",MatrixColumnIndexColumnName=@"UserId",MatrixRowIndexColumnName=@"ProductId",ApproximationRank=32,LearningRate=0.30086123644479035,NumberOfIterations=327,Quiet=true}))      
